...
class DatasetLoader:
    ...
    def load_paws_dataset(self, split: str = "train", max_samples: int = 20000) -> List[str]:
    ...
    def load_wikipedia_articles(self, topics: List[str] = None, sentences_per_topic: int = 150) -> List[str]:
    ...
    def load_arxiv_abstracts(self, categories: List[str] = None, max_papers: int = 2000) -> List[str]:
    ...
    def load_quora_question_pairs(self, max_samples: int = 30000) -> List[str]:
        """
    ...
    def load_combined_corpus(self, target_size: int = 50000) -> List[str]:
        ...
        quora_target = int(target_size * 0.25)
        ...
        wiki_sentences = self.load_wikipedia_articles(
            ...
            sentences_per_topic=max(30, target_size // len(self.academic_topics) // 4)
        )
        ...
        arxiv_target = max(200, int(target_size * 0.2))
        arxiv_sentences = self.load_arxiv_abstracts(max_papers=max(50, arxiv_target // 4))
